...
namespace Athkar.Shareds.Extensions;

/// <summary>
/// Convention-based DI registration. A service is auto-registered when the
/// injectable attribute is placed on the <b>interface</b> — the single
/// implementing class is then registered against it. For infrastructure types
/// the attribute may also sit on the class itself.
/// </summary>
